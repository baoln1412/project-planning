...
> **Team**: 1-2 engineers + 1 UA manager (part-time reviewer)

## Milestones

| Milestone | Sprint | Week | Success Criteria | Gate |
|---|---|---|---|---|
| **M1: Foundation Live** | 1 | 2 | n8n + Dify running locally, TikTok API connected, AppsFlyer pipeline integrated | Demo: trigger workflow → Dify responds |
| **M2: First AI Campaign** | 2 | 4 | Strategist agent generates plan, GenAI produces creatives, TikTok campaign goes live | Demo: brief → live ad in <15 min |
| **M3: Closed Loop (1 platform)** | 3 | 6 | Monitor agent reading AppsFlyer, HITL Slack flow working, auto-pause active | **📌 REVIEW GATE**: Measure lift vs. manual |
| **M4: Multi-Platform** | 4 | 8 | Facebook + Google deployment working, spend data pulling, monitoring extended | Demo: 3-platform campaign launch |
| **M5: Full Engine** | 5 | 10 | Creative analytics, LTV bidding, stress-tested, documented | System handed off to UA team |

---

## Sprint Breakdown

### Sprint 1: Foundation + Planning Agent (Weeks 1-2)

| # | Task | Owner | Est. | Dependencies | Deliverable |
|---|---|---|---|---|---|
| 1.1 | Set up Docker Compose (n8n + Dify + PostgreSQL + Redis) | Eng | 2d | None | Working `docker-compose.yml` |
| 1.2 | Configure TikTok Ads API credentials in n8n | Eng | 0.5d | 1.1 | Verified API connection |
| 1.3 | Connect AppsFlyer data pipeline to n8n webhook | Eng | 1d | 1.1 | Real-time events flowing into n8n |
| 1.4 | Create PostgreSQL schema (campaigns, creatives, audit_logs, decisions) | Eng | 1d | 1.1 | Migration scripts |
| 1.5 | Load historical campaign data into Dify Knowledge Base | Eng + UA | 1d | 1.1 | RAG knowledge base populated |
| 1.6 | Build Dify "Campaign Strategist" agent (ReAct) | Eng | 2d | 1.5 | Agent generates CampaignPlan JSON |
| 1.7 | Build n8n Campaign Planning workflow | Eng | 1d | 1.6 | Workflow: trigger → Dify → plan stored |
| 1.8 | Build n8n Token Refresh workflow (TikTok) | Eng | 0.5d | 1.2 | Auto-refresh CRON job |
| 1.9 | Integration testing: end-to-end planning flow | Eng | 1d | 1.7 | Demo-ready |

**Sprint 1 Total**: ~10 person-days
